...
contract PandExchange {
    ...
    */
    ...
    /*
        ...
        [1, 7, 0, 100000, "0x0000000000000000000000000000000000000000", "0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee", 0, ["0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd", "0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee"], 500, "0xD99D1c33F9fC3444f8101754aBC46c52416550D1", 500]
    */
    ...
    function addNewDCAToUser(
        ...
        if (_userDCAData.tokenIn != address(0)) {
            ...
            require(
                ...
                "Error: Wrong amount of BNB sent"
            );
        }
